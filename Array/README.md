...
|           [drop](https://github.com/Pyotato/Pyodash/tree/main/Array/drop)           | `drop(arr,n=1)`함수는 `arr`배열의 첫 인덱스에서부터 n까지의 요소를 제거한 배열을 리턴합니다.                                                                                                       |
|      [dropRight](https://github.com/Pyotato/Pyodash/tree/main/Array/dropRight)      | `dropRight(arr,n=1)`함수는 `arr`배열의 끝 인덱스에서부터 n까지의 요소를 제거한 배열을 리턴합니다.                                                                                                  |
